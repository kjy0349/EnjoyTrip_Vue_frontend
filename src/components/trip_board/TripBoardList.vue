...
import { listArticle, totalPage } from '@/api/tboard'
import { onMounted, ref } from 'vue'
import { searchArticleBySubject } from '@/api/tboard'
import TripBoardListItem from './item/TripBoardListItem.vue'
